...
![20190612111652](https://img.iszy.cc/20190612111652.png?x-oss-process=style/mystyle)
...
![20190612112558](https://img.iszy.cc/20190612112558.png?x-oss-process=style/mystyle)
...
![20190612123004](https://img.iszy.cc/20190612123004.png?x-oss-process=style/mystyle)

这些存储桶的添加命令可以简化，如以`extras`存储库为例，输入`scoop bucket add extras`即可。

![20190612123538](https://img.iszy.cc/20190612123538.png?x-oss-process=style/mystyle)
