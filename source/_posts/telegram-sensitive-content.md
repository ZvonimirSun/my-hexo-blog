...
1. 点击菜单中的 `Settings` 打开设置
   ...
   ![Settings](https://img.ovooo.cc/20210802093233.png)

2. 点击 `Privacy and Security`

   ![Privacy and Security](https://img.ovooo.cc/20210802093803.png)

3. 打开 `Disable filtering` 开关

   ![Disable filtering](https://img.ovooo.cc/20210802093917.png)
...
2. 打开菜单
   ...
   ![菜单位置](https://img.ovooo.cc/20210620194729.png)

3. 打开 `Settings` - `Privacy and Security` - `Sensitive Content`

   ![Settings](https://img.ovooo.cc/20210620194935.png)

   ![Privacy and Security](https://img.ovooo.cc/20210620195102.png)

4. 打开 `Disable filtering` 开关

   ![Disable filtering](https://img.ovooo.cc/20210620195246.png)
