...
![ESLint](https://img.iszy.cc/1632972151436.png)

如果需要支持 Vue，还需要安装 `Vetur` 插件。

![Vetur](https://img.iszy.cc/1632972292437.png)

当然项目中需要在 devDependencies 里添加 eslint 相关内容。

![devDependencies](https://img.iszy.cc/1632972500989.png)
...
![](https://img.iszy.cc/1632973295099.png)
...
![快捷键](https://img.iszy.cc/1632973421746.png)

此时会列出当前可以绑定快捷键的所有功能和快捷键，在这里搜索`fix`。

![修复快捷键](https://img.iszy.cc/1632973767580.png)
...
![](https://img.iszy.cc/1632973867998.png)
