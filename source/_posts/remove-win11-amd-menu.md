...
![](https://img.ovooo.cc/1671064733303.png)
...
![](https://img.ovooo.cc/1671065063988.png)

在这个 Server 里面，有的人是键值 `0`，有的是键值 `1`，点到这个键值下，我这边键值是 `0`。

![](https://img.ovooo.cc/1671065176268.png)
...
![](https://img.ovooo.cc/1671065384645.png)

![](https://img.ovooo.cc/1671065443124.png)

这样菜单就不显示了，如果想要恢复展示，删掉这条字符串值即可。

![](https://img.ovooo.cc/1671065556009.png)
