...
![页面预览](https://img.ovooo.cc/1722480749524.png)

比如我需要 80 版本的 Chromium，这里就可以看下 80 分支的信息，主要需要这个 `Branch Pos.` 的内容，如图所示。

![](https://img.ovooo.cc/1722480814407.png)
...
![](https://img.ovooo.cc/1657769779611.png)

然后根据 `Position` 号找到对应的版本

![](https://img.ovooo.cc/1657769834283.png)

可能会搜不到，可以手动拉到对应 `Position` 号附近的版本，大版本号基本是一致的。比如这里我选择了 `612439` 版本。

![](https://img.ovooo.cc/1657769953873.png)

下载对应的压缩版，解压即可使用。比如这里就是`chrome-win.zip`。

![](https://img.ovooo.cc/1657770071034.png)

### 开始使用吧

![](https://img.ovooo.cc/1657770205975.png)
